...
class AudioManager {
    ...
    constructor() {
        this._pauseFade = (x, stepSize) => {
            var _a;
            if (x <= 0) {
                x = 0;
                (_a = this._currentTrack) === null || _a === void 0 ? void 0 : _a.element.pause();
            }
            if (x >= 1) {
                x = 1;
            }
    ...
    _crossFade(x, stepSize) {
        ...
        if (x < 1) {
            ...
            (_a = this._fadeOutTrack) === null || _a === void 0 ? void 0 : _a.element.pause();
        }
    }
    /**
     ...
     */
    playMusic(musicId, continueWhereLeft = false) {
        this._resumeAudioContext();
        ...
        return newTrack.element.play().catch(e => {
            ...
            setTimeout(() => newTrack === null || newTrack === void 0 ? void 0 : newTrack.element.play(), 50);
        });
    }
    pause() {
    ...
    unpause() {
        ...
        (_a = this._currentTrack) === null || _a === void 0 ? void 0 : _a.element.play();
    }
}
