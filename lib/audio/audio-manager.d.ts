...
declare class AudioManager {
    ...
    get currentTrack(): SoundEffect | undefined;
    private constructor();
    /**
     ...
     */
    registerSfx(file: string | null, sfx: SoundConfiguration): Promise<HTMLAudioElement>;
     ...
     * @param groupId the name of the group
     */
    playRandomSound(groupId: string): SoundEffect | null | undefined;
     ...
     */
    playSound(soundId: string): SoundEffect | null;
    /**
     ...
     */
    playMusic(musicId: string, continueWhereLeft?: boolean): Promise<void> | undefined;
    private _pauseFade;
    pause(): void;
    unpause(): void;
}
