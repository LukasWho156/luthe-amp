...
type IGame = {
     ...
     */
    loadTexture: (file: string, id: string) => Promise<THREE.Texture>;
    /**
     ...
     */
    loadSound: (file: string, config: SoundConfiguration) => Promise<HTMLAudioElement>;
    /**
...
export { GameConfiguration, IGame, Game };
